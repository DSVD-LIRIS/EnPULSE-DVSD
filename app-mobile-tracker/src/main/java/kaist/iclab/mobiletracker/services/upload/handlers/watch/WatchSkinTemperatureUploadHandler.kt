...
class WatchSkinTemperatureUploadHandler(
    ...
    override suspend fun uploadData(userUuid: String, lastUploadTimestamp: Long): Result<Long> {
        return ErrorClassifier.runClassified(sensorId, "upload $sensorId") {
            ...
            supabaseDataList.chunked(Constants.Network.UPLOAD_BATCH_SIZE).forEach { chunk ->
                service.insertSkinTemperatureSensorDataBatch(chunk)
                    .getOrElse { throw it }
            }
    ...
    override fun getCsvHeader(): String {
        return "eventId,uuid,received,timestamp,ambientTemp,objectTemp,status"
    }

    override fun recordToCsvRow(record: Any): String {
        val entity = record as kaist.iclab.mobiletracker.db.entity.watch.WatchSkinTemperatureEntity
        return "${entity.eventId},${entity.uuid},${entity.received},${entity.timestamp},${entity.ambientTemp},${entity.objectTemp},${entity.status}"
    }
}
